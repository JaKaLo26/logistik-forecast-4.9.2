...
def zerogpu_healthcheck():
    """
    Minimal ZeroGPU-Funktion, damit der Space im kostenlosen
    ZeroGPU-Modus starten kann. Die eigentliche Forecast-App
    bleibt CPU-/API-basiert.
    """
    return "ok"
